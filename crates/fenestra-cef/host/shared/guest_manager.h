#ifndef FENESTRA_CEF_HOST_GUEST_MANAGER_H_
#define FENESTRA_CEF_HOST_GUEST_MANAGER_H_
...
#define FENESTRA_CEF_MAJOR CEF_VERSION_MAJOR
#elif defined(CHROME_VERSION_MAJOR)
#define FENESTRA_CEF_MAJOR CHROME_VERSION_MAJOR
#else
#define FENESTRA_CEF_MAJOR 0
#endif

// CEF 133 added the |popup_id| parameter to CefLifeSpanHandler::OnBeforePopup.
#if FENESTRA_CEF_MAJOR >= 133
#define FENESTRA_CEF_POPUP_ID int popup_id,
#else
#define FENESTRA_CEF_POPUP_ID
#endif

// Guest id reserved for the legacy `fenestra.popup` surface.
extern const char kFenestraPopupGuestId[];
