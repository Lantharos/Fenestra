...
//!
//! Apps and the CLI call [`ensure_host`] to materialize `mullion-host` next to
//! a CEF runtime. Process launch and window wiring stay in the `mullion` crate.
...
fn bridge_js_header() -> String {
    ...
    output.push_str(
        "// AUTO-GENERATED by mullion-host from\n\
