...
int RunMullionHost(CefMainArgs main_args, int argc, char* argv[]) {
  CefRefPtr<MullionApp> app(new MullionApp);
...
int APIENTRY wWinMain(HINSTANCE hInstance,
  ...
  return RunMullionHost(main_args, __argc, __argv);
}
#else
NO_STACK_PROTECTOR
int main(int argc, char* argv[]) {
  CefMainArgs main_args(argc, argv);
  return RunMullionHost(main_args, argc, argv);
}
#endif
