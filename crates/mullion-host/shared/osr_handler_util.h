#ifndef MULLION_CEF_HOST_OSR_HANDLER_UTIL_H_
#define MULLION_CEF_HOST_OSR_HANDLER_UTIL_H_
...
class MullionOsrHandler;

namespace mullion_osr {

extern MullionOsrHandler* g_instance;
extern std::mutex g_handlers_mutex;
extern std::vector<MullionOsrHandler*> g_handlers;
