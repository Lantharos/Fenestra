#ifndef MULLION_CEF_HOST_OSR_HANDLER_H_
#define MULLION_CEF_HOST_OSR_HANDLER_H_
...
class MullionOsrHandler : public CefClient,
 ...
 public:
  MullionOsrHandler(std::string endpoint,
 ...
 private:
  ...
  friend class MullionGuestRequestContextHandler;
