    ...
    pub async fn new(window: Arc<dyn Window>) -> Result<Self, RendererError> {
        ...
        let globals_bind_group_layout =
            device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
                label: Some("mullion globals bind group layout"),
        ...
        let globals_bind_group = device.create_bind_group(&wgpu::BindGroupDescriptor {
            label: Some("mullion globals bind group"),
        ...
        let image_sampler = device.create_sampler(&wgpu::SamplerDescriptor {
            label: Some("mullion image sampler"),
        ...
        let image_bind_group_layout =
            device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
                label: Some("mullion image per-texture bind group layout"),
                entries: &[
    ...
    pub fn render(&mut self, display_list: &DisplayList) -> Result<(), RendererError> {
        ...
        let mut encoder = self
            ...
            .create_command_encoder(&wgpu::CommandEncoderDescriptor {
                label: Some("mullion render encoder"),
            });

        {
            let mut pass = encoder.begin_render_pass(&wgpu::RenderPassDescriptor {
                label: Some("mullion render pass"),
                ...
                let vertex_buffer =
                    self.device
                        .create_buffer_init(&wgpu::util::BufferInitDescriptor {
                            label: Some("mullion rounded rect vertices"),
            ...
            for draw in &image_draws {
                ...
                let vertex_buffer =
                    self.device
                        .create_buffer_init(&wgpu::util::BufferInitDescriptor {
                            label: Some("mullion image vertices"),
