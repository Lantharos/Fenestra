...
pub const BEGIN_COMMAND: &str = "mullion.activity.begin";
pub const END_COMMAND: &str = "mullion.activity.end";
pub const LIST_COMMAND: &str = "mullion.activity.list";
pub const POPUP_OPEN_COMMAND: &str = "mullion.popup.open";
pub const POPUP_CLOSE_COMMAND: &str = "mullion.popup.close";
...
pub struct MullionActivityLease {
...
impl Drop for MullionActivityLease {
    fn drop(&mut self) {
        self.end_inner();
    }
}
...
/// `mullion.activity.begin` / `mullion.activity.end` events to the page.
