...
```toml
[dependencies]
sabine = { git = "https://github.com/Lantharos/Sabine", tag = "v0.1.5" }
```

```sh
cargo install --git https://github.com/Lantharos/Sabine --tag v0.1.5 sabine-cli
```

For the TypeScript helpers used by the web UI:

```sh
bun add github:Lantharos/Sabine#v0.1.5
```
