...
Sabine source code is licensed under `MIT OR Apache-2.0`.

Sabine can resolve, download, build against, or bundle third-party webview
runtimes. Those runtimes are not licensed by Sabine's project license.
...
When a Sabine app bundles or redistributes a CEF/Chromium runtime, the bundle
...
directory under `~/.local/share/sabine/runtimes/cef/`.
